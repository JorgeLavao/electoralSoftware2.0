    ...
    <div
        ...
        <div
            ...
            <div
                ...
                <template x-if="modal === 2">
                    <div>
                        <img src="https://picsum.photos/320/220?random=2" class="mb-4 h-48 w-full rounded-xl object-cover">
                        <p class="text-sm text-gray-500">Agosto 30 de 2025</p>
                        <h3 class="mt-1 text-xl font-bold text-gray-900">Encuentro político impulsa nuevas propuestas sociales</h3>
                        <p class="mt-4 leading-relaxed text-gray-700">
                            Líderes y ciudadanos compartieron ideas orientadas al desarrollo local, la inclusión y el fortalecimiento institucional.
                        </p>
                        <div class="mt-auto flex items-center justify-end gap-x-2">
                ...
                <template x-if="modal === 3">
                    <div>
                        <img src="https://picsum.photos/320/220?random=3" class="mb-4 h-48 w-full rounded-xl object-cover">
                        <p class="text-sm text-gray-500">Julio 12 de 2025</p>
                        <h3 class="mt-1 text-xl font-bold text-gray-900">Juventudes participan en agenda de renovación política</h3>
                        <p class="mt-4 leading-relaxed text-gray-700">
                            Espacios de diálogo con jóvenes buscan construir propuestas políticas innovadoras con visión de futuro y compromiso ciudadano.
                        </p>
                        <div class="mt-auto flex items-center justify-end gap-x-2">
                ...
                <template x-if="modal === 4">
                    <div>
                        <img src="https://picsum.photos/320/220?random=4" class="mb-4 h-48 w-full rounded-xl object-cover">
                        <p class="text-sm text-gray-500">Junio 05 de 2025</p>
                        <h3 class="mt-1 text-xl font-bold text-gray-900">Liderazgo político reafirma compromiso con el territorio</h3>
                        <p class="mt-4 leading-relaxed text-gray-700">
                            La organización política continúa promoviendo acciones cercanas a la ciudadanía para responder a sus principales necesidades.
                        </p>
                        <div class="mt-auto flex items-center justify-end gap-x-2">
