            ...
            <div class="modal-inner__data space-y-5">
                <header class="section-header">
                    <div class="section-header__title">
                        <hgroup>
                            <h3 class="text-grey-400">Agregar Comite</h3>
                        </hgroup>
                    </div>
                    <hr>
                </header>

                <form wire:submit="saveCommittee" method="POST" class="space-y-5">
                    <div class="container-v">
                        <div class="group-form-v">
                            <label for="committee-name">Nombre del Comite<span class="text-red-500">*</span></label>
                            <input type="text" id="committee-name" wire:model="name" placeholder="Digite el nombre del comite" required>
                        </div>
                        <div>
                    ...
                    <div class="container-v">
                        <div class="group-form-v">
                            <label for="committee-description">Descripcion del Comite<span class="text-red-500">*</span></label>
                            <textarea id="committee-description" rows="4" wire:model="description" placeholder="Describe el objetivo, alcance y funcionamiento del comite" required></textarea>
                        </div>
                        <div>
                    ...
                    <div class="container-v area-2">
                        ...
                        <div class="grop-columns-2">
                            <div class="container-v">
                                <div class="group-form-v">
                                    <label for="available-people">Disponibles</label>
                                    <input
                                        id="available-people"
                                        type="text"
                                ...
                                <div class="container-h item item__secondary justify-between" wire:key="available-user-{{ $person->id }}">
                        ...
                        <div class="container-v">
                            <div class="group-form-v">
                                <label for="committee-people">En el Comite</label>
                                <input
                                    id="committee-people"
                                    type="text"
                            ...
                            <div class="container-v area-3">
                                ...
                                <div class="container-h item item__secondary justify-between" wire:key="committee-user-{{ $person->id }}">
                                    <div class="container-v gap-1">
                                        <strong>{{ $person->fullName }}</strong>
                                        <span class="text-sm text-gray-400">{{ $person->document_number }}</span>
                                        <span class="text-sm text-gray-400">{{ $person->celphone }}</span>
