        ...
        <div class="container-v mb-8">
            ...
            <form wire:submit.prevent="save" class="space-y-5">
                <div class="group-form-v">
                    ...
                    <input type="text" id="title" wire:model="title" placeholder="Digite el título" required>
                    @error('title') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                </div>

                <div class="group-form-v">
                    <label for="description">Descripción<span class="text-red-500">*</span></label>
                    <textarea id="description" wire:model="description" rows="4" placeholder="Escriba el contenido de la noticia" required></textarea>
